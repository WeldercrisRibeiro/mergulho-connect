...
CREATE TABLE public.baileys_auth (
...
CREATE TABLE public.devotionals (
    ...
    media_url text NULL,
    publish_date timestamptz(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    ...
    video_url text NULL,
    is_video_upload bool DEFAULT false NULL,
...
CREATE TABLE public."groups" (
    ...
    icon text DEFAULT 'users'::text NULL,
    created_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE public.landing_photos (
    ...
    is_banner bool DEFAULT false NULL,
...
CREATE TABLE public.volunteers (
    ...
    interest_areas _text DEFAULT ARRAY []::text [] NULL,
...
CREATE TABLE public.wz_dispatches (
    title text NOT NULL,
    "content" text NULL,
    "type" text NOT NULL,
...
CREATE TABLE public.devotional_likes (
    ...
    CONSTRAINT devotional_likes_devotional_id_fkey FOREIGN KEY (devotional_id) REFERENCES public.devotionals(id) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE public.events (
    ...
    "location" text NULL,
    is_general bool DEFAULT true NOT NULL,
    group_id uuid NULL,
    created_by uuid NULL,
    created_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    event_type text DEFAULT 'simple'::text NOT NULL,
    ...
    map_url text NULL,
    send_whatsapp bool DEFAULT false NULL,
    require_checkin bool DEFAULT false NULL,
    checkin_qr_secret text NULL,
    is_public bool DEFAULT false NOT NULL,
    CONSTRAINT events_pkey PRIMARY KEY (id),
    CONSTRAINT events_group_id_fkey FOREIGN KEY (group_id) REFERENCES public."groups"(id) ON DELETE
...
CREATE TABLE public.group_routines (
    ...
    CONSTRAINT group_routines_group_id_fkey FOREIGN KEY (group_id) REFERENCES public."groups"(id) ON DELETE
    SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE public.member_groups (
    ...
    joined_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT member_groups_pkey PRIMARY KEY (id),
    CONSTRAINT member_groups_group_id_fkey FOREIGN KEY (group_id) REFERENCES public."groups"(id) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE public.profiles (
    ...
    CONSTRAINT profiles_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE public.user_roles (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid NOT NULL,
    "role" public."app_role" DEFAULT 'membro'::app_role NOT NULL,
...
CREATE TABLE public.volunteer_schedules (
    ...
    item_user_id uuid NULL,
    group_id uuid NULL,
    created_by uuid NULL,
    created_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT volunteer_schedules_pkey PRIMARY KEY (id),
    CONSTRAINT volunteer_schedules_group_id_fkey FOREIGN KEY (group_id) REFERENCES public."groups"(id) ON DELETE
    SET NULL ON UPDATE CASCADE,
        CONSTRAINT volunteer_schedules_item_user_id_fkey FOREIGN KEY (item_user_id) REFERENCES public.profiles(user_id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE public.wz_dispatch_attachments (
    "type" text NOT NULL,
    ...
    CONSTRAINT wz_dispatch_attachments_dispatch_id_fkey FOREIGN KEY (dispatch_id) REFERENCES public.wz_dispatches(id) ON DELETE CASCADE ON UPDATE CASCADE
);
-- public.wz_dispatch_logs definição
-- Drop table
-- DROP TABLE public.wz_dispatch_logs;
CREATE TABLE public.wz_dispatch_logs (
    ...
    CONSTRAINT wz_dispatch_logs_dispatch_id_fkey FOREIGN KEY (dispatch_id) REFERENCES public.wz_dispatches(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE public.announcements (
    ...
    CONSTRAINT announcements_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.profiles(user_id) ON DELETE
    SET NULL ON UPDATE CASCADE,
        CONSTRAINT announcements_group_id_fkey FOREIGN KEY (group_id) REFERENCES public."groups"(id) ON DELETE
    SET NULL ON UPDATE CASCADE
);
-- public.culto_reports definição
-- Drop table
-- DROP TABLE public.culto_reports;
CREATE TABLE public.culto_reports (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    report_date date NOT NULL,
    report_type text DEFAULT 'culto'::text NOT NULL,
    total_attendees int4 DEFAULT 0 NOT NULL,
    children_count int4 DEFAULT 0 NOT NULL,
    youth_count int4 DEFAULT 0 NOT NULL,
    monitors_count int4 DEFAULT 0 NOT NULL,
    public_count int4 DEFAULT 0 NOT NULL,
    notes text NULL,
    event_id uuid NULL,
    escala_data jsonb DEFAULT '[]'::jsonb NULL,
    created_by uuid NULL,
    created_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT culto_reports_pkey PRIMARY KEY (id),
    CONSTRAINT culto_reports_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.events(id) ON DELETE
    SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE public.event_checkins (
    ...
    user_id uuid NOT NULL,
    checked_in_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT event_checkins_pkey PRIMARY KEY (id),
    CONSTRAINT event_checkins_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.events(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE public.event_registrations (
    ...
    CONSTRAINT event_registrations_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.events(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE public.event_reports (
    ...
    children_count int4 DEFAULT 0 NULL,
    monitors_count int4 DEFAULT 0 NULL,
    youth_count int4 DEFAULT 0 NULL,
    public_count int4 DEFAULT 0 NULL,
    total_offerings numeric DEFAULT 0 NULL,
    tithes_amount numeric DEFAULT 0 NULL,
    tithers jsonb DEFAULT '[]'::jsonb NULL,
    notes text NULL,
    created_by uuid NULL,
    created_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    visitors_count int4 DEFAULT 0 NOT NULL,
    preacher text NULL,
    sermon_ref text NULL,
    pastors _text NULL,
    worship_team _text NULL,
    welcome_team _text NULL,
    media_team _text NULL,
    CONSTRAINT event_reports_pkey PRIMARY KEY (id),
    CONSTRAINT event_reports_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.profiles(user_id) ON DELETE
    SET NULL ON UPDATE CASCADE,
        CONSTRAINT event_reports_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.events(id) ON DELETE
    SET NULL ON UPDATE CASCADE,
        CONSTRAINT event_reports_group_id_fkey FOREIGN KEY (group_id) REFERENCES public."groups"(id) ON DELETE
    SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE public.event_rsvps (
    ...
    CONSTRAINT event_rsvps_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.events(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE public.kids_checkins (
    ...
    call_requested bool DEFAULT false NULL,
    category text DEFAULT 'checkin'::text NULL,
    event_id uuid NULL,
    created_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NULL,
    updated_at timestamptz(6) DEFAULT CURRENT_TIMESTAMP NULL,
    CONSTRAINT kids_checkins_pkey PRIMARY KEY (id),
    CONSTRAINT kids_checkins_guardian_id_fkey FOREIGN KEY (guardian_id) REFERENCES public.profiles(user_id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE public.messages (
    ...
    CONSTRAINT messages_recipient_id_fkey FOREIGN KEY (recipient_id) REFERENCES public.profiles(user_id) ON DELETE
    SET NULL ON UPDATE CASCADE,
        CONSTRAINT messages_sender_id_fkey FOREIGN KEY (sender_id) REFERENCES public.profiles(user_id) ON DELETE RESTRICT ON UPDATE CASCADE
);