      ...
      <div className="relative pointer-events-auto">
        {!isOpen ? (
          <button
            ...
            className="bg-emerald-500 text-white p-4 rounded-full shadow-2xl hover:bg-emerald-600 hover:scale-110 transition-all duration-300 group flex items-center justify-center min-w-[56px] h-14"
          >
          ...
          <button
            ...
            className="bg-zinc-100 dark:bg-zinc-800 text-zinc-500 rounded-full shadow-lg hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-all duration-300 animate-in fade-in zoom-in duration-300 flex items-center justify-center w-14 h-14"
          >
            <X className="h-6 w-6" />
          </button>
        )}
